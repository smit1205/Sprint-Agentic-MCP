...
public class SelfHealingHelper {
    ...
    public WebElement findWithAutoHeal(By primary) {
        String hint = extractHint(primary);             //extract hint By.id("username") Then hint = "username"
        ...
        return findElement(primary, autoFallbacks.toArray(new By[0]));          //healing happens here
    }
    ...
    public WebElement findElement(By primary, By... fallbacks) {
        ...
        for (int i = 0; i < fallbacks.length; i++) {
            ...
            try {
                //fallback 1 - try visibilityOfElementLocated() ; you can add as much fallback you want
    ...
    public void safeClick(WebElement element) {
        try {
            ...
            System.out.println("[SELF-HEAL]  Click intercepted — retrying with JS click");
            try {
                ...
                System.out.println("[SELF-HEAL] JS click failed — retrying with Actions");
    ...
    private String extractHint(By locator) {
        ...
        return s.contains(": ") ? s.substring(s.indexOf(": ") + 2).trim() : s;   //extracts hint By.id("username") to username
    }
}
